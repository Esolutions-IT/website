...
<div class="about__wrapper">
    <div class="about__collumn">
        <div class="about__text">
            ...
            <br/>
            <p class="about__text--paragraphs">De naam Esolutions-IT is ontstaan door de achternaam van Gertjan genaamd ‘Egas’. Vervolgens staat er solutions-it omdat Esolutions-IT, IT diensten aanbiedt.</p>
        </div>
    </div>
    <div class="about__collumn">
