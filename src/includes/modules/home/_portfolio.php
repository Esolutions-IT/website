		...
		<div class="sideleft">
			...
			<div class="vertical">
				<div class="vslide one">
					<label class="vslide--first" for="firstslider"></label>
					<label class="vslide--second" for="secondslider"></label>
                    <label class="vslide--third" for="threeslider"></label>
					<label class="vslide--foured" for="fourslider"></label>
				</div>
...
<!-- COMPUTERS SLIDER -->
	<div class="cont">
		<div class="lefts">
			...
			<div class="image">
				<img src="./public/gfx/portfolio/hausnorah/hausnorah_1.jpg" alt="Macbook">
